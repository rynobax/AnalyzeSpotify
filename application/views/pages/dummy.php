...
<h1><b>Real</b></h1><hr size=><h4><b>Hipster rating: 57 / 100</b></h4>The hipster rating is based on the popularity of the playlist's tracks on spotify.<hr>    <table class="table table-striped table-hover">
    ...
    {
		label: 'Rock',
		backgroundColor : "rgba(202,31,245,1)",
		...
		label: 'Folk',
		backgroundColor : "rgba(50,128,246,1)",
		...
		label: 'Electronic',
		backgroundColor : "rgba(40,246,123,1)",
		...
		label: 'Pop',
		backgroundColor : "rgba(205,251,24,1)",
    ...
    {
		label: 'Rock',
		backgroundColor : "rgba(210,36,254,1)",
		...
		label: 'Folk',
		backgroundColor : "rgba(18,112,253,1)",
		...
		label: 'Electronic',
		backgroundColor : "rgba(25,255,117,1)",
		...
		label: 'Pop',
		backgroundColor : "rgba(209,249,49,1)",
		...
		label: 'Other',
		backgroundColor : "rgba(248,19,19,1)",
